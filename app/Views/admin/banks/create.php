    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                ...
                <form action="<?= base_url('admin/banks/store') ?>" method="post">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= isset($errors['bank_name']) ? 'is-invalid' : '' ?>" id="bank_name" name="bank_name" value="<?= old('bank_name') ?>" required>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i> Add Bank
                        </button>
