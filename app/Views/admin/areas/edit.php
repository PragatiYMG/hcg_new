                    ...
                    <div class="card-body">
                        ...
                        <?php if (session()->getFlashdata('warning')): ?>
                            <div class="alert alert-warning alert-dismissible">
                                ...
                                <br><small>If you want to proceed anyway, click "Update Area" again.</small>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control <?= isset($errors['visible_to_customer']) ? 'is-invalid' : '' ?>" id="visible_to_customer" name="visible_to_customer" required>
                                ...
                                <option value="yes" <?= old('visible_to_customer', $area['visible_to_customer']) == 'yes' ? 'selected' : '' ?>>Yes</option>
                                <option value="no" <?= old('visible_to_customer', $area['visible_to_customer']) == 'no' ? 'selected' : '' ?>>No</option>
                            </select>
