        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="customerForm" action="<?= base_url('admin/customers/update/' . $customer['id']) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field() ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customer_photo" name="customer_photo"
                                               accept="image/*">
                                        <label class="custom-file-label" for="customer_photo">Choose new photo file</label>
                                    </div>
                                    <small class="form-text text-muted">Leave empty to keep current photo. Max 2MB, JPG/PNG/WebP formats</small>
                                    <?php if ($customer['customer_photo'] && file_exists(ROOTPATH . 'public/uploads/' . $customer['customer_photo'])): ?>
                                        <div class="mt-2">
                                            <p class="mb-1">Current Photo:</p>
                                            <img src="<?= base_url('uploads/' . $customer['customer_photo']) ?>" alt="Current Photo" class="img-thumbnail" style="max-width: 100px; max-height: 100px;">
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="father_husband_name" name="father_husband_name"
                                           value="<?= old('father_husband_name', $customer['father_husband_name']) ?>" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="primary_mobile" name="primary_mobile"
                                           value="<?= old('primary_mobile', $customer['primary_mobile']) ?>" required
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="aadhaar_number" name="aadhaar_number"
                                           value="<?= old('aadhaar_number', $customer['aadhaar_number']) ?>" required
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="aadhaar_attachment" name="aadhaar_attachment"
                                               accept="image/*,.pdf">
                                        <label class="custom-file-label" for="aadhaar_attachment">Choose new Aadhaar file</label>
                                    </div>
                                    <small class="form-text text-muted">Leave empty to keep current file. Max 2MB, JPG/PNG/PDF formats</small>
                                    <?php if ($customer['aadhaar_attachment'] && file_exists(ROOTPATH . 'public/uploads/' . $customer['aadhaar_attachment'])): ?>
                                        <div class="mt-2">
                                            <p class="mb-1">Current Aadhaar File: <a href="<?= base_url('uploads/' . $customer['aadhaar_attachment']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">View</a></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="secondary_id_type" name="secondary_id_type">
                                        ...
                                        <option value="voter_id" <?= old('secondary_id_type', $customer['secondary_id_type']) === 'voter_id' ? 'selected' : '' ?>>Voter ID</option>
                                        <option value="passport" <?= old('secondary_id_type', $customer['secondary_id_type']) === 'passport' ? 'selected' : '' ?>>Passport</option>
                                        <option value="driving_license" <?= old('secondary_id_type', $customer['secondary_id_type']) === 'driving_license' ? 'selected' : '' ?>>Driving License</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="secondary_id_number" name="secondary_id_number"
                                           value="<?= old('secondary_id_number', $customer['secondary_id_number']) ?>" maxlength="50">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="secondary_id_attachment" name="secondary_id_attachment"
                                               accept="image/*,.pdf">
                                        <label class="custom-file-label" for="secondary_id_attachment">Choose new ID file</label>
                                    </div>
                                    <small class="form-text text-muted">Leave empty to keep current file. Max 2MB, JPG/PNG/PDF formats</small>
                                    <?php if ($customer['secondary_id_attachment'] && file_exists(ROOTPATH . 'public/uploads/' . $customer['secondary_id_attachment'])): ?>
                                        <div class="mt-2">
                                            <p class="mb-1">Current Secondary ID File: <a href="<?= base_url('uploads/' . $customer['secondary_id_attachment']) ?>" target="_blank" class="btn btn-sm btn-outline-primary">View</a></p>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
...
document.getElementById('customerForm').addEventListener('submit', function(e) {
    ...
    .catch(function(error) {
        ...
        showAlert('danger', 'An error occurred while updating the customer');
    })
    .finally(function() {
