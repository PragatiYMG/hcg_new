                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= isset(session()->getFlashdata('errors')['first_name']) ? 'is-invalid' : '' ?>" id="first_name" name="first_name" value="<?= old('first_name') ?>" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?= isset(session()->getFlashdata('errors')['last_name']) ? 'is-invalid' : '' ?>" id="last_name" name="last_name" value="<?= old('last_name') ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control <?= isset(session()->getFlashdata('errors')['department_id']) ? 'is-invalid' : '' ?>" id="department_id" name="department_id">
                                        ...
                                        <?php if (!empty($departments)): foreach ($departments as $dept): ?>
                                            <option value="<?= esc($dept['id']) ?>" <?= old('department_id') == $dept['id'] ? 'selected' : '' ?>><?= esc($dept['department_name']) ?></option>
